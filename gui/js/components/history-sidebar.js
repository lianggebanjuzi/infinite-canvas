// js/components/history-sidebar.js
// 右侧侧边栏 + 本次会话生成历史图库

const HistorySidebar = {

    _isExpanded: false,
    _items: [],          // { src, timestamp, resolution, aspectRatio } 数组
    ...
    _bindCanvasDrop() {
        ...
        if (!container || container._historyDropBound) return;
        ...
        container._historyDropBound = true;
    },
